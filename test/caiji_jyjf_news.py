...
def data_insert(my_conn,my_cur,item):
    SQL = """INSERT INTO news(pid,title,cate1,cate2,from_web,addtime,content,material,abstract,title_img,keyword) 
...
def get_data(item, _url):
    ...
    for i in info:
        ...
        i = re.sub(r'</a>', '', i)
        i = re.sub(r'<a .*?>', '', i)
        #i = re.sub(r'\<img(.*?)src="(.*?)".*?\>', r'<img src="\2" title="金洋九峰科技发展有限公司系专业生产电动伸缩门厂家,严格要求制作工艺,保证产品完美品质,以品质占领市场.咨询热线:185-3008-5166">', i)
