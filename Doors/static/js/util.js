...
var initStyle = function (opt) {
    ...
    var mobileTpl = '.mobile .header,.msg-lr .header{background-color:{0} !important} ' +
        ' .mobile .inMsg,.mobile .inMsg .msg,.msg-lr .inMsg,.msg-lr .inMsg .msg{background-color:{1};color:#FFF !important} ' +
        ' .mobile .inMsg .msg-cursor,.msg-lr .inMsg .msg-cursor{border-left-color:{1}}' +
        ' .mobile .inMsg .msg-cursor-inner,.msg-lr .inMsg .msg-cursor-inner {border-right-color:{1}}' +
